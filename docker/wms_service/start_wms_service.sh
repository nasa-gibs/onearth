...
OE_STATUS_REDIRECT_ENDPOINT=$(yq eval ".mapserver.redirect_endpoint" /etc/onearth/config/endpoint/oe-status_reproject.yaml)
mkdir -p $OE_STATUS_REDIRECT_ENDPOINT
cp /var/www/cgi-bin/mapserv.fcgi $OE_STATUS_REDIRECT_ENDPOINT/wms.cgi
