...
export ONEARTH_VERSION=2.9.4 # This must be manually incremented with each OnEarth version

# The onearth release to use in the Docker image tag (e.g. onearth-wms:{ONEARTH_VERSION}-{ONEARTH_RELEASE}).
export ONEARTH_RELEASE=gitc-5810 # This must be manually incremented with each OnEarth build