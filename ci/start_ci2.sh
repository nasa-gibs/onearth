...
python3 /usr/bin/oe2_wmts_configure.py ../src/test/mapserver_test_data/test_endpoint.yaml
...
/usr/bin/redis-cli  -n 0 ZADD layer:test_daily_png:periods 0 "2012-02-29/2012-02-29/P1D"
/usr/bin/redis-cli  -n 0 DEL layer:test_legacy_subdaily_jpg
/usr/bin/redis-cli  -n 0 SET layer:test_legacy_subdaily_jpg:default "2012-02-29T14:00:00"
/usr/bin/redis-cli  -n 0 ZADD layer:test_legacy_subdaily_jpg:periods 0 "2012-02-29T12:00:00Z/2012-02-29T14:00:00Z/PT2H"
/usr/bin/redis-cli  -n 0 DEL layer:test_nonyear_jpg
/usr/bin/redis-cli  -n 0 SET layer:test_nonyear_jpg:default "2012-02-29"
/usr/bin/redis-cli  -n 0 ZADD layer:test_nonyear_jpg:periods 0 "2012-02-29/2012-02-29/P1D"
/usr/bin/redis-cli  -n 0 DEL layer:test_weekly_jpg
/usr/bin/redis-cli  -n 0 SET layer:test_weekly_jpg:default "2012-02-29"
/usr/bin/redis-cli  -n 0 ZADD layer:test_weekly_jpg:periods 0 "2012-02-22/2012-02-29/P7D"
/usr/bin/redis-cli  -n 0 DEL layer:test_zenjpeg_ZENJPEG
/usr/bin/redis-cli  -n 0 SET layer:test_zenjpeg_ZENJPEG:default "2012-02-22"
/usr/bin/redis-cli  -n 0 ZADD layer:test_zenjpeg_ZENJPEG:periods 0 "2012-02-22/2012-02-22/P1D"
/usr/bin/redis-cli  -n 0 DEL layer:test_zenjpeg
/usr/bin/redis-cli  -n 0 SET layer:test_zenjpeg:default "2012-02-22"
/usr/bin/redis-cli  -n 0 ZADD layer:test_zenjpeg:periods 0 "2012-02-22/2012-02-22/P1D"
/usr/bin/redis-cli  -n 0 DEL layer:test_brunsli_zenjpeg_ZENJPEG
/usr/bin/redis-cli  -n 0 SET layer:test_brunsli_zenjpeg_ZENJPEG:default "2012-02-22"
/usr/bin/redis-cli  -n 0 ZADD layer:test_brunsli_zenjpeg_ZENJPEG:periods 0 "2012-02-22/2012-02-22/P1D"
/usr/bin/redis-cli  -n 0 DEL layer:test_brunsli_zenjpeg
/usr/bin/redis-cli  -n 0 SET layer:test_brunsli_zenjpeg:default "2012-02-22"
/usr/bin/redis-cli  -n 0 ZADD layer:test_brunsli_zenjpeg:periods 0 "2012-02-22/2012-02-22/P1D"
/usr/bin/redis-cli  -n 0 DEL layer:snap_test_1a
/usr/bin/redis-cli  -n 0 SET layer:snap_test_1a:default "2016-02-29"
/usr/bin/redis-cli  -n 0 ZADD layer:snap_test_1a:periods 0 "2015-01-01/2016-12-31/P1D"
/usr/bin/redis-cli  -n 0 DEL layer:snap_test_2a
/usr/bin/redis-cli  -n 0 SET layer:snap_test_2a:default "2015-01-01"
/usr/bin/redis-cli  -n 0 ZADD layer:snap_test_2a:periods 0 "2015-01-01/2015-01-10/P1D"
/usr/bin/redis-cli  -n 0 ZADD layer:snap_test_2a:periods 0 "2015-01-12/2015-01-31/P1D"
/usr/bin/redis-cli  -n 0 DEL layer:snap_test_3a
/usr/bin/redis-cli  -n 0 SET layer:snap_test_3a:default "2015-01-01"
/usr/bin/redis-cli  -n 0 ZADD layer:snap_test_3a:periods 0 "2015-01-01/2016-01-01/P1M"
/usr/bin/redis-cli  -n 0 ZADD layer:snap_test_3a:periods 0 "1948-01-01/1948-03-01/P1M"
/usr/bin/redis-cli  -n 0 DEL layer:snap_test_3b
/usr/bin/redis-cli  -n 0 SET layer:snap_test_3b:default "2015-01-01"
/usr/bin/redis-cli  -n 0 ZADD layer:snap_test_3b:periods 0 "2015-01-01/2016-01-01/P3M"
/usr/bin/redis-cli  -n 0 DEL layer:snap_test_3c
/usr/bin/redis-cli  -n 0 SET layer:snap_test_3c:default "2000-01-01"
/usr/bin/redis-cli  -n 0 ZADD layer:snap_test_3c:periods 0 "1990-01-01/2016-01-01/P1Y"
/usr/bin/redis-cli  -n 0 DEL layer:snap_test_3d
/usr/bin/redis-cli  -n 0 SET layer:snap_test_3d:default "2010-01-01"
/usr/bin/redis-cli  -n 0 ZADD layer:snap_test_3d:periods 0 "2010-01-01/2012-03-11/P8D"
/usr/bin/redis-cli  -n 0 DEL layer:snap_test_4a
/usr/bin/redis-cli  -n 0 SET layer:snap_test_4a:default "2000-01-01"
/usr/bin/redis-cli  -n 0 ZADD layer:snap_test_4a:periods 0 "2000-01-01/2000-06-01/P1M"
/usr/bin/redis-cli  -n 0 ZADD layer:snap_test_4a:periods 0 "2000-07-03/2000-07-03/P1M"
/usr/bin/redis-cli  -n 0 ZADD layer:snap_test_4a:periods 0 "2000-08-01/2000-12-01/P1M"
/usr/bin/redis-cli  -n 0 DEL layer:snap_test_4b
/usr/bin/redis-cli  -n 0 SET layer:snap_test_4b:default "2001-01-01"
/usr/bin/redis-cli  -n 0 ZADD layer:snap_test_4b:periods 0 "2001-01-01/2001-12-27/P8D"
/usr/bin/redis-cli  -n 0 ZADD layer:snap_test_4b:periods 0 "2002-01-01/2002-12-27/P8D"
/usr/bin/redis-cli  -n 0 DEL layer:snap_test_4c
/usr/bin/redis-cli  -n 0 SET layer:snap_test_4c:default "2010-01-01"
/usr/bin/redis-cli  -n 0 ZADD layer:snap_test_4c:periods 0 "2010-01-01/2010-01-01/P385D"
/usr/bin/redis-cli  -n 0 DEL layer:snap_test_5a
/usr/bin/redis-cli  -n 0 SET layer:snap_test_5a:default "2011-12-01"
/usr/bin/redis-cli  -n 0 ZADD layer:snap_test_5a:periods 0 "2002-12-01/2011-12-01/P1Y"
...
/usr/bin/redis-cli -n 0 ZADD layer:Raster_Status:periods 0 "2004-08-01/2004-08-01/P1M"
/usr/bin/redis-cli  -n 0 SAVE

# MapServer configs
python3 /usr/bin/oe2_wms_configure.py ../src/test/mapserver_test_data/test.yaml
