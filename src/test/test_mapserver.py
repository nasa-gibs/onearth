...
class TestMapserver(unittest.TestCase):
    ...
    def test_request_wms_date_url_encoded_layer(self):
        """
        ...
        if DEBUG:
            ...
            print('URL: ' + req_url)
        check_result = check_tile_request(req_url, ref_hash)
        self.assertTrue(check_result, 'WMS date request using a URL-encded date range does not match what\'s expected. URL: ' + req_url)

    def test_wms_get_capabilities_1_1_1(self):
        """
        9. Request WMS GetCapabilities 1.1.1
        """
    ...
    def test_wms_get_capabilities_1_3_0(self):
        """
        10. Request WMS GetCapabilities 1.3.0
        """
    ...
    def test_wfs_get_capabilities_2_0_0(self):
        """
        11. Request WFS GetCapabilities 2.0.0
        """
    ...
    def test_wfs_get_capabilities_version_error(self):
        """
        13. Request an invalid GetCapabilities version
        """
    ...
    def test_request_wms_layer_error(self):
        """
        14. Request erroneous layer via WMS
        """
    ...
    def test_request_wms_datesnap_outofrange(self):
        """
        19. Request multiple layers with multi-day period and snap to date that is out of range via WMS
        """
...
#         """
#         21. Request multiple layers with bad date format via WMS
#         """
...
#         self.assertTrue(check_result, 'WMS KMZ does not match what\'s expected. URL: ' + req_url)
    ...
    def test_request_wfs_geojson(self):
        """
        26. Request GeoJSON from vector source file via WFS
        """
    ...
    def test_request_wfs_csv(self):
        """
        27. Request CSV from vector source file via WFS
        """
    ...
    def test_request_wfs_geojson_with_time(self):
        """
        28. Request GeoJSON from vector source file with time via WFS
        """
    ...
    def test_request_wfs_csv_with_time(self):
        """
        29. Request CSV from vector source file with time via WFS
        """
        ref_hash = '3a5f4e8439c778560864478dda58b4af'
    ...
    def test_request_wms_baddate(self):
        """
        30. Request multiple layers with bad date via WMS
        """
        ref_hash = '3f935e491dc208f39c6a34b1db9caa65'
    ...
    def test_request_wms_badtime(self):
        """
        31. Request multiple layers with bad time via WMS
        """
...
#         """
#         32. Request multiple layers with bad time format via WMS
#         """
#         ref_hash = 'c8f9d083f85fca56a7c0539fc5813793'
...
#         self.assertTrue(check_result, 'WMS multiple layers bad time format does not match what\'s expected. URL: ' + req_url)
    ...
    def test_request_wms_no_layer_error(self):
        """
        33. Request missing layers via WMS
        """
    ...
    def test_wms_status(self):
        """
        37. Tests the request used in the "/wms/status" endpoint in the OnEarth Demo.
    ...
    def test_request_zenjpeg_source_jpeg(self):
        ...
        """
        req_url = 'http://localhost/wms/test/wms.cgi?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetMap&FORMAT=image%2Fjpeg&TRANSPARENT=true&LAYERS=test_zenjpeg_ZENJPEG&CRS=EPSG%3A4326&STYLES=&WIDTH=1024&HEIGHT=1024&BBOX=-90,-180,90,180&TIME=2012-02-22'
    ...
    def test_request_invalid_getfeature_format(self):
        """
        47. Test a GetFeature request using an invalid format.
        """
